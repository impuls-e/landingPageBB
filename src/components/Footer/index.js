    ...
    <React.Fragment>
      <div className="container footer">
        ...
        <div className="contact">
          ...
          <div className="section">
            <h5>Informaçōes:</h5>
            <a className="online" href="https://belabelinda.com/pages/sobre-nos">
              Sobre Nós
            </a>
            <a className="online" href="https://belabelinda.com/pages/sobre-nos">
        ...
        <p className="credits">
          © 2020 <a href="https://belabelinda.com/">Bela Belinda</a>
        </p>
        <div className="cred-card">
          <Img fluid={data.card.childImageSharp.fluid} alt="Cartões de pagamento" />
        </div>
      </div>
    </React.Fragment>
  );
